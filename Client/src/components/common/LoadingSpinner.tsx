...
export function PageLoader() {
  return (
    ...
    >
      {/* App logo mark */}
      <div className="animate-pulse-ring flex h-14 w-14 items-center justify-center rounded-xl"
        style={{ background: 'var(--primary-blue)' }}
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="34" height="33" fill="none" viewBox="0 0 48 46" aria-hidden="true">
